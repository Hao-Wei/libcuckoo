...
if __name__ == '__main__':
	...
	#tables = ["random", "ndquad", "hopscotch"]
	...
	for table in tables:
		for thread in threads:
			runTest(table, thread, total_ops=100, initial_capacity=27, prefill=75, reads=100)
			runTest(table, thread, total_ops=50, initial_capacity=27, prefill=25, inserts=100)
			runTest(table, thread, total_ops=100, initial_capacity=27, prefill=50, reads = 90, inserts=10)
